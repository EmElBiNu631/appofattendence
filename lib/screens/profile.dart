                ...
                child: Column(
                  ...
                  children: [
                                      ...
                                      showDialog(
                                        ...
                                        builder: (_) => PunchInDialog(
                                          onSelect: (location) {
                                            ...
                                            vm.punchOutWithLocation(location); // You define this in your ViewModel
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                    ...
                    GridView.count(
                      ...
                      children: const [
                        DashboardButton(icon: Icons.calendar_month, label: "Attendance"),
                        DashboardButton(icon: Icons.logout, label: "Leaves"),
                        DashboardButton(icon: Icons.pie_chart, label: "Leave Status"),
                        DashboardButton(icon: Icons.list, label: "Holiday List"),
                        DashboardButton(icon: Icons.receipt, label: "Payslip"),
                        DashboardButton(icon: Icons.bar_chart, label: "Reports"),
                      ],
                    ),
